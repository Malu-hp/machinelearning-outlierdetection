...
intradayS = authd_client.intraday_time_series('activities/steps', base_date    = '2015-06-14', detail_level = '1min', start_time   = None, end_time     = None)
 
f = open('datadumpSteps.json', 'w')
json.dump(intradayS, f)
 
intradayH = authd_client.intraday_time_series('activities/heart', base_date    = '2015-06-14', detail_level = '1sec', start_time   = None, end_time     = None)
